    ...
    <header class="header">
        ...
        <div class="navbar">
            <div class="navbar-left-container">
                <h1 class="yxh-logo">YMall</h1>
            </div>
            <div class="navbar-right-container" style="display: flex;">
                <div class="navbar-menu-container">
                    <span class="navbar-link" v-text="nickName" v-if="nickName"></span>
                    <a href="javascript:void(0)" class="navbar-link yxh-move_font" @click="loginModalFlag=true" v-if="!nickName">Login</a>
                    <a href="javascript:void(0)" class="navbar-link yxh-move_font" @click="registerModalFlag=true" v-if="!nickName" >Register</a>

                    <a href="javascript:void(0)" class="navbar-link yxh-move_font" @click="logOut" v-else>Logout</a>
                ...
                <div class="md-content">
                    <div class="confirm-tips">
                        <div class="error-wrap">
                            <span class="error error-show" v-show="errorTip">?????????</span>
                        </div>
                        <ul>
                ...
                <div class="md-content">
                    <div class="confirm-tips">
                        ...
                        <ul>
                            ...
                            <li class="regi_form_input noMargin">
                                <i class="icon IconPwd"></i>
                                <input type="password" tabindex="2"  name="password" v-model="userPwd" class="regi_login_input regi_login_input_left login-input-no input_text" placeholder="Password" @keyup.enter="register">
                            </li>
                        </ul>
                    </div>
                    <div class="login-wrap">
                        <a href="javascript:;" class="btn-login" @click="register">register</a>
                    </div>
                </div>
            </div>
        </div>

        <div class="md-overlay" v-if="loginModalFlag || registerModalFlag" @click="registerModalFlag = loginModalFlag = false"></div>
        <!-- ?????? -->
    </header>
</template>
<style>
...
<script>
    ...
    import {state,mutations} from '@/components/store.vue'
        ...
        methods:{
            ...
            login(){
                ...
                axios.post("/api/user/login",data).then((response)=>{
                    let res = response.data;
                    mutations.nickName(res.data.username);
